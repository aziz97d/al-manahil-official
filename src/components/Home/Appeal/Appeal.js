  ...
  return (
    <section className="appeal-section">
      <div className="appeal-section-header">
        <h1>“<span>Charity </span> extinguishes the sins like water <br /> extinguishes a <span> fire</span>” </h1>
        <p>(Ibn Majah)</p>
      </div>
      ...
      <div className="appeals">
        ...
        <Link to="/appealDetails" className="appeal">
          <div
            className="appeal-sub"
            style={{ borderBottom: "3px solid #00AD50" }}
          >
            <img src={waterWell} />
            ...
            <p>
              ...
              <br />
              In this world, drinking water is the most essential thing for
              human life during day and night.
        ...
        <div className="appeal">
          <div
            className="appeal-sub"
            style={{ borderBottom: "3px solid #F57920" }}
          >
            <img src={food} />
            ...
            <p>
              <strong>Food</strong>
              <br />
              Donate your sadaqah online today to make a real difference for
              someone in need.{" "}
            </p>
          </div>
        </div>
        <div className="appeal">
          ...
          >
            ...
            <p>
              ...
              <br />
              The necessity of toilets/bathrooms is profound in the life of
              mankind during day and night as these are necessary for natural
              waste excretion as well as for bathing, ablution, and cleanliness
              purposes.
        ...
        <div className="appeal">
          ...
          >
            ...
            <p>
              ...
              <br />
              To construct a Masjid of Allah is the best construction project in
              the world.
        ...
        <div className="appeal">
          ...
          >
            ...
            <p>
              ...
              <br /> Build a well in the name of Prophet's Mohammad (saw) family{" "}
            </p>
          </div>
        </div>
        <div className="appeal">
        ...
        <div className="appeal">
          ...
          >
            ...
            <p>
              ...
              <br />
              The month Ramadan is a great gift for the Muslim nation from
              Allah. In one hand a golden chance for gaining virtue awaits and
              on the other hand there are great means for forgiving sins in the
              month of Ramadan. There is a golden chance for gaining virtues by
              performing multifaceted welfare activities including worship,
              prayer, zikir, du'a, dorud etc.
            </p>
          </div>
        </div>
        <div className="appeal">
